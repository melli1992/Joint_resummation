...
C	
       CALL RENOP (UN, DN, SN, CN, GLN, XN, Q2UP)
       RETURN
       END
C
C                                                                               
...
C...AND STRUCTURE FUNCTIONS :
       SUBROUTINE RENOP (UN, DN, SN, CN, GLN, XN, Q2UP)
...
c       DOUBLE PRECISION ESQ, EFO, EFS, ALP, ALPS, ALP0, ALPC, ALPB,
c     1                  ALPT, ALPQ, XL, S, XL1, ES, PI
       AC  = 1.- AL
       SCOM   = LOG (XLCOMPLEX)
       XL1COM = 1.- XLCOMPLEX
       ESCOM  = EXP (-SCOM)
